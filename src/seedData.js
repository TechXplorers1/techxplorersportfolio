export const initialServices = [
    // Identity Services
    {
        ...
        price: "$30",
        features: ["ATS Friendly", "Modern Layout", "Key Skills Highlight"],
        icon: "FileText",
        highlight: false
    },
    {
        ...
        price: "$200",
        features: ["Custom Domain", "Responsive Design", "SEO Optimized"],
        icon: "Globe",
        highlight: false
    },
    {
        ...
        price: "Contact Us",
        features: ["Multiple Portal Setup", "Daily Applications", "Mock Interview Prep"],
        icon: "Star",
        highlight: true
    },
    // Engineering Services
    {
        ...
        price: "Custom",
        features: ["Scalable Solutions", "Secure Architecture", "Mobile First"],
        icon: "Terminal",
        highlight: false
    },
    {
        ...
        price: "Custom",
        features: ["SEO & ADS", "Content Strategy", "Social Branding"],
        icon: "Monitor",
        highlight: false
    },
    {
        ...
        price: "Custom",
        features: ["PMP & AWS Certified", "CISA & CISM Prep", "CompTIA Security+"],
        icon: "Award",
        highlight: true
    }
];
